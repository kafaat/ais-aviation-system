...
export const responseContracts = {
  ...
  getYieldAnalysis: z.array(
    z.object({
      ...
      originCode: z.string(),
      destinationCode: z.string(),
      totalRevenue: outputNumber.nullable(),
      passengerCount: outputNumber,
      distanceKm: outputNumber.nullable(),
      rpk: outputNumber.nullable(),
      yield: outputNumber.nullable(),
      ...
      coverage: z.enum([
        ...
        "missing_evidence",
        "unavailable_source",
        "missing_recognized_revenue",
      ]),
      passengerBasis: z.literal("funded_active_membership"),
    })
  ),
