...
// Build the plugins array. PWA assets are intentionally served from client/public:
// client/public/sw.js is the single service-worker authority and is registered by
// usePWA.ts. Do not add a second service-worker generator here.
