...
CREATE TABLE `seat_inventory` (
	...
	CONSTRAINT `seat_inv_flight_seat_uq` UNIQUE(`flightId`,`seatNumber`)
);
--> statement-breakpoint
...
ALTER TABLE `passengers` ADD CONSTRAINT `passengers_ticket_number_uq` UNIQUE(`ticketNumber`);--> statement-breakpoint
