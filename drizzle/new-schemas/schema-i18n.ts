import { mysqlTable, int, varchar, text, timestamp, index, boolean } from "drizzle-orm/mysql-core";
...
export const translations = mysqlTable("translations", {
  ...
  lookupIdx: index("lookup_idx").on(table.contentTypeId, table.entityId, table.fieldName, table.locale),
}));
